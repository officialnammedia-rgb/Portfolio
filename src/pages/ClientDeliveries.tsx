...
const DELIVERIES: Delivery[] = [
  {
    ...
    url: "real-estate-website-ten-snowy.vercel.app",
    href: "https://real-estate-website-ten-snowy.vercel.app",
    desc: "An ultra-luxury architectural real estate platform showcasing modern sanctuary residences, interactive virtual tours, curated floorplans, and private booking consultations.",
    stack: ["React", "Tailwind CSS", "Vite", "Framer Motion"],
    image: "/previews/zenith-realty.png",
  },
  {
    id: "02",
    title: "Elysian Estates",
    category: "Real Estate",
    url: "real-estate-v02.vercel.app",
    href: "https://real-estate-v02.vercel.app",
    desc: "A high-end private brokerage portal presenting an exclusive collection of luxury villas, penthouses, and global estates with bespoke inquiry channels.",
    stack: ["React", "Tailwind CSS", "Vite", "Luxury UI"],
    image: "/previews/elysian-estates.png",
  },
  {
    id: "03",
    title: "Gurukul Football Academy",
    category: "Sports",
    url: "gurukulfc.com",
    href: "https://gurukulfc.com",
    desc: "A high-performance academy portal for Gurukul FC featuring trial registrations, player training pathways, match milestones, official merchandise store, and Razorpay payments.",
  ...
  },
  {
    ...
    desc: "A gorgeous, modern website designed for a cozy cafe. Currently optimized for desktop view with dynamic menus and booking inquiries.",
